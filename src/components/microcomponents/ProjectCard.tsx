...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div className={`relative w-full h-full rounded-2xl shadow-lg overflow-hidden border-2 transition-transform duration-300 hover:scale-105
    ...
    `}>
      ...
      <div className="p-4 md:p-6 flex flex-col gap-3">
        ...
        <div>
          ...
          <div className={`h-[2px] w-16 my-1.5 ${isDarkMode ? "bg-white/50" : "bg-black/50"}`} />
        </div>
          ...
          {project.badges.map((tech) => {
            ...
            return (
              <a
                ...
                className={`flex items-center gap-1.5 border px-2.5 py-1.5 rounded-md text-xs font-medium shadow-sm
...
<div className="flex gap-4 mt-2">
  ...
  {project.liveDemo && (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`relative group text-xl transition-colors duration-300
